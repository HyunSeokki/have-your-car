...
function myFunction() {
   ...
   // document.getElementById('loader-map').style.display = "none";
    $('#loader-map').stop(true).animate({'opacity' : 0}, 400, function() {
...
<div  style="height:100vh; width:480px; position: relative;">
    <div class="row" id="loader-map" style="position: absolute; width: 480px; height: 700px; z-index: 2; background-color:white; text-align:center;">
            <div id="loader">
            ...
            <span style="position: absolute; left:38%; top:48%; font-size:2rem; font-weight:bold; color:#013469;">Loading ...</span>
    </div>
