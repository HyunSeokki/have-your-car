...
public class BasicSampleController extends HController {
    ...
    public String test(@ModelAttribute("basicSampleVO") BasicSampleVO basicSampleVO, Model model) throws Exception {
    ...
    public String insertItem(@ModelAttribute @Valid BasicSampleVO basicSampleVO, BindingResult result, Model model)
            throws Exception {
    ...
    public String updateItemForm(@ModelAttribute BasicSampleVO basicSampleVO, Model model,
            @RequestParam("selectedSeq") String seq) throws Exception {
    ...
    public String updateItem(@ModelAttribute @Valid BasicSampleVO basicSampleVO, BindingResult result, Model model)
            throws Exception {
